...
type MyWizardContext = Scenes.WizardContext<CreateAccountWizardState>; // telegraf

// ПОСЛЕ:
import type { CreateAccountWizardState, SessionContext } from "../types/index.js"; // grammy
```
